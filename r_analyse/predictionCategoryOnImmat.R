...
#Grouper par cluster
immatGrouped = immat %>% group_by(prediction) %>% summarise(immatriculation = immatriculation, marque=marque, nom=nom, puissance = puissance, longueur=longueur, nbPlaces=nbPlaces, nbPortes=nbPortes, couleur=couleur, occasion=occasion, prix=prix, categoryName=categoryName);immatGrouped
View(immatGrouped)
